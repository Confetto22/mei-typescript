...
const Success = (props: Props) => {
  return (
    <section className="success-story bg-[url('https://res.cloudinary.com/dv9aqxptd/image/upload/v1737054656/homchapel/DSC_0651_vl9kpf.webp')] bg-center bg-cover ">
      <div className="success-cover bg-[#] bg-gradient-to-r from-[#4b1b0c93] to-[#00162ed2] min-h-[60vh] text-[.9rem] text-stone-300 py-16 px-6 flex flex-col gap-6 items-center text-center justify-center ">
